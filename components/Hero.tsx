...
export default function Hero() {
  return (
    <section className='w-full px-4 relative flex flex-row justify-center items-center'>
      <div className='max-w-7xl mx-auto py-24 w-full flex flex-row justify-between items-center'>
        <div className='flex flex-col justify-start items-start'>
            <div className='flex flex-row items-center mb-6 gap-2 bg-textTwo rounded-3xl py-2 px-4'>
